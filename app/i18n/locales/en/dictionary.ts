...
export const dictionary: Dictionary = {
  ...
  auth: {
    ...
    login: {
      ...
      subtitle: "Sign in to order in one tap and collect cashback.",
      submit: "Sign in",
    },
    register: {
      title: "Create an account",
      subtitle: "Bonuses from your first order, history and quick booking.",
    ...
    legal: "By creating an account you agree to the Mubarak terms of service.",
    session: { title: "You're signed in", home: "Back to home", logout: "Sign out" },
    errors: {
      fields: "Please fill in every field",
      email: "Enter a valid email",
      password: "Password must be at least {min} characters",
      credentials:
        "Wrong email or password. If you signed up with Google, use Google sign-in.",
      emailTaken: "This email is already taken. Try signing in.",
      blocked: "This account is blocked. Contact us to sort it out.",
      googleCancelled: "Google sign-in cancelled",
      googleFailed: "Google sign-in failed. Please try again.",
      googleExpired: "The sign-in window expired. Please try again.",
      googleUnavailable: "Google sign-in is not configured yet",
